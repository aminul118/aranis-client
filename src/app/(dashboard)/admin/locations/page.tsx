...
import LocationForm from '@/app/(dashboard)/admin/locations/_components/LocationForm';
import LocationTable from '@/app/(dashboard)/admin/locations/_components/LocationTable';
